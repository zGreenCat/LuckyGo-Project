...
<div class="container flex mx-auto">
    <form id="regForm" class="max-w-lg mx-auto bg-gray-100 p-9 rounded-lg shadow-lg w-full" method="POST" action="{{ route('buyTicket') }}" novalidate>
        ...
        <button type="submit" class="text-white bg-[#0A74DA] hover:bg-[#084A91] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center transition duration-200">Comprar</button>
    </form>
</div>
